...
class Graph(Entity):
  def __init__(self, name):
    ...
    self.__graph.write('  subgraph cluster_0 {{ label="Legend"; legend [image="result/graphs/legend_{1}.{0}" label="" shape="none"]; }}\n'.format(sys.argv[1], self.__name))
  ...
  def append_node(self, node):
    self.__graph.write(self.compact_string(node.compile()))
